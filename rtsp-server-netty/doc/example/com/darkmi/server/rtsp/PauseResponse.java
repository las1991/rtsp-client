...
public class PauseResponse implements Callable<HttpResponse> {
    private static Logger logger = LoggerFactory.getLogger(PauseResponse.class);
    private HttpRequest request = null;

    public PauseResponse(HttpRequest request) {
