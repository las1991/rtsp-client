...
public class TeardownResponse implements Callable<HttpResponse> {
  private static Logger logger = LoggerFactory.getLogger(TeardownResponse.class);
  private HttpRequest request = null;

  public TeardownResponse(HttpRequest request) {
