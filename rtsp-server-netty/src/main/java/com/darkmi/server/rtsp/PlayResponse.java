...
public class PlayResponse implements Callable<HttpResponse> {
    private static Logger logger = LoggerFactory.getLogger(PlayResponse.class);
    private HttpRequest request = null;

    public PlayResponse(HttpRequest request) {
