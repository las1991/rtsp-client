...
public final class SessionDescription extends Section {
    ...
    public boolean equals(Object o) {
        if (o instanceof SessionDescription) {
            ...
            return Objects.equals(version, s.getVersion()) &&
                    Objects.equals(origin, s.getOrigin()) &&
                    Objects.equals(name, s.getSessionName()) &&
                    Objects.equals(info, s.getInfo()) &&
                    Objects.equals(uri, s.getUri()) &&
                    Arrays.equals(emails, s.getEmails()) &&
                    Arrays.equals(phones, s.getPhones()) &&
                    Arrays.equals(times, s.getTimeDescriptions()) &&
                    Objects.equals(zones, s.getTimeZones()) &&
                    Objects.equals(connection, s.getConnection()) &&
                    Arrays.equals(bandwidths, s.getBandwidths()) &&
                    Objects.equals(key, s.getKey()) &&
